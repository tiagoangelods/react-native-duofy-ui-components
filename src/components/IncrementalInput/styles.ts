...
export const getStyles = (props: any) => {
  ...
  const input = tw`flex flex-row items-center justify-center grow text-center font-bold p-0 m-0 ${
    inputDisabled ? 'text-brand-black-light' : 'text-brand-black-primary'
  }`;
